...
import { HandbackController } from './controller';
import { parsePullRequestUrl } from './model';
import './styles.css';

export class PrHandbackAssigneeFeature implements Feature {
  readonly id = 'pr-handback-assignee';
  private controller: HandbackController | null = null;
  ...
  start({ url }: FeatureContext): void {
    ...
    this.controller = new HandbackController(ref);
